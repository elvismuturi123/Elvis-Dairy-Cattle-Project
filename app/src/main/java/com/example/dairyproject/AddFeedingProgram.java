...
public class AddFeedingProgram extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        FeedingProgramDbRef = FirebaseDatabase.getInstance().getReference("Feeding Program");
        saveFprogram.setOnClickListener(v -> {
            ...
            Feed feed = new Feed (feedDayId, FeedingDtae,FeedTpe,Components, MilkProduced,CattleNumber,ProgramNotes);
